        ...
        <tbody>
          {filteredDisbursements.map((disbursement) => (
            <tr key={disbursement.id} className="border-b hover:bg-gray-50">
              <td className="py-4 px-4"><div className="font-medium">{disbursement.id}</div></td>
              <td className="py-4 px-4"><div className="font-medium">{disbursement.merchantName}</div></td>
              ...
              <td className="py-4 px-4"><Badge variant="outline">{disbursement.recipientBank}</Badge></td>
              <td className="py-4 px-4"><div className="font-medium">Rp {disbursement.amount.toLocaleString()}</div></td>
              <td className="py-4 px-4">
                <div className="flex items-center space-x-2">
                  {getStatusIcon(disbursement.status)}
                  <Badge className={getStatusColor(disbursement.status)}>{disbursement.status}</Badge>
                </div>
              </td>
              <td className="py-4 px-4">
                <div className="text-sm">
                  <div>Maker: {disbursement.maker}</div>
                  {disbursement.checker && <div>Checker: {disbursement.checker}</div>}
                </div>
              </td>
              <td className="py-4 px-4 text-sm text-gray-600">{disbursement.createdAt}</td>
              <td className="py-4 px-4">
                <div className="flex items-center space-x-2">
